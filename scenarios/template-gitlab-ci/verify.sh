#!/usr/bin/env bash
# Validate the upstream gitlab-ci.yml template at v0.9.24 end-to-end.
#
# 4 steps:
#
# 1. Curl the upstream `docs/ci-templates/gitlab-ci.yml` at v0.9.24
...
#
# Optional knobs:
#   UPSTREAM_VERSION    override the version tag (default 0.9.24).
...
UPSTREAM_VERSION="${UPSTREAM_VERSION:-0.9.24}"
