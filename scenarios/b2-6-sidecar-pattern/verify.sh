...
step "Write report"
{
  echo "# B2-6 sidecar pattern (1 daemon per service)"
  echo
...
if [ "${verdict}" = "PASS" ]; then
  ok "B2-6 PASS, see ${REPORT}"
  exit 0
else
  die "B2-6 ${verdict}, see ${REPORT}"
fi
