#!/usr/bin/env bash
# Validate the upstream github-actions.yml template at v0.9.23.
#
# 3 steps:
#
# 1. Fetch upstream `docs/ci-templates/github-actions.yml` at v0.9.23.
# 2. Structural lint:
...
#
# Optional knobs:
#   UPSTREAM_VERSION    override version (default 0.9.23)
