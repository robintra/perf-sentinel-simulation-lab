#!/usr/bin/env bash
# Validate the upstream github-actions.yml template at v0.25.2.
#
# 3 steps:
#
# 1. Fetch upstream `docs/ci-templates/github-actions.yml` at v0.25.2.
# 2. Structural lint:
...
#
# Optional knobs:
#   UPSTREAM_VERSION    override version (default 0.25.2)
...
UPSTREAM_VERSION="${UPSTREAM_VERSION:-0.25.2}"
