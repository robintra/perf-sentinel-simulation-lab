#!/usr/bin/env bash
# Validate the upstream github-actions.yml template at v0.25.0.
#
# 3 steps:
#
# 1. Fetch upstream `docs/ci-templates/github-actions.yml` at v0.25.0.
# 2. Structural lint:
...
#
# Optional knobs:
#   UPSTREAM_VERSION    override version (default 0.25.0)
...
UPSTREAM_VERSION="${UPSTREAM_VERSION:-0.25.0}"
