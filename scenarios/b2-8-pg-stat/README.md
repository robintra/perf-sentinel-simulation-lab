# B2-8 perf-sentinel report --pg-stat live integration
...
`/tmp/scenario-b2-8-pg-stat-report.md` plus the dashboard at
`/tmp/b2-8-pg-stat/dashboard.html` and the CSV at
`/tmp/b2-8-pg-stat/pg-stat.csv`.
