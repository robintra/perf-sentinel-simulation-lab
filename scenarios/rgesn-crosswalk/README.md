...
every release without ever touching the version under validation. The
gate reported a PASS for code it had not executed. The 0.9.25 round is
what surfaced that, and the eight image scenarios now share this
resolution.
