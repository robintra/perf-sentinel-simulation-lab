...
| `observability` | deny-all | DNS, Tempo intra-ns, daemon intra-ns, daemon 14318 from Grafana, Prometheus 9090 from Grafana, Electricity Maps API (FQDN), grafana.com + storage.googleapis.com (FQDN, Grafana only) | OTel from `shop`, Prometheus scrape, Prometheus 9090 from Grafana |
