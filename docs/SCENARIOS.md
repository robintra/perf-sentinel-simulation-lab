...
The 61 scenarios live under `scenarios/<name>/` and each one ships a
...
# All 61 (sequential, long-running-drift is the long pole)
...
`make verify-all-scenarios` includes all 61 scenarios, in an order
