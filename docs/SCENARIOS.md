...
The 69 scenarios live under `scenarios/<name>/` and each one ships a
...
# All 69 (sequential, long-running-drift is the long pole)
...
`make verify-all-scenarios` includes all 69 scenarios, in an order
