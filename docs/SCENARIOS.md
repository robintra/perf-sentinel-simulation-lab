...
The 62 scenarios live under `scenarios/<name>/` and each one ships a
...
# All 62 (sequential, long-running-drift is the long pole)
...
`make verify-all-scenarios` includes all 62 scenarios, in an order
...
quarantined out of the count of 62 until it goes green. Its shared browser
