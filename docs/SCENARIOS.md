...
The 53 scenarios live under `scenarios/<name>/` and each one ships a
...
# All 53 (sequential, long-running-drift is the long pole)
...
`make verify-all-scenarios` includes all 53 scenarios, in an order
