...
.PHONY: help up down reset recover validate smoke status logs grafana inspect psql ps clean-images \
        ...
        seed-quarkus-svc seed-mutiny-svc seed-helidon-mp-svc seed-helidon-se-svc seed-dotnet-svc seed-go-svc seed-nest-svc seed-django-svc seed-fastapi-svc seed-diesel-svc seed-seaorm-svc seed-rails-svc \
